...
describe("day12", () => {
  describe("day12", () => {
    it("handles demo input for part 1 correctly", async () => {
      const [part1] = await day12("./src/2022/day12/testInput.txt");

      expect(part1).toBe(31);
    });

    it("handles demo input for part 2 correctly", async () => {
      const [, part2] = await day12("./src/2022/day12/testInput.txt");
  ...
  describe("findShortestPathFromStart", () => {
    it("finds shortest path in test data", async () => {
      const heightMap = await loadHeightMap("./src/2022/day12/testInput.txt");
  ...
  describe("findShortestPathFromAnyLowElevation", () => {
    it("finds shortest path in test data", async () => {
      const heightMap = await loadHeightMap("./src/2022/day12/testInput.txt");
